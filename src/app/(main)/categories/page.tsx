...
export default function CategoriesPage() {
  ...
  const categoryTransactionCounts = React.useMemo(() => {
    ...
    const filteredTransactions =
      accountId === "all"
        ? transactions
        : transactions.filter((t: Transaction) => t.accountId === Number.parseInt(accountId))

    return categories.map((category: Category) => {
      const count = filteredTransactions.filter((t: Transaction) => t.categoryId === category.categoryId).length
